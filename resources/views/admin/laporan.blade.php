          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Pengajuan Masuk</h3>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($item['status_pengajuan'] == 2)
                          ...
                          <a href="/selesaiPengajuan/{{ $item['id_pengajuan'] }}" class="btn btn-primary" onclick="return confirm('Tekan Ya Untuk Melanjutkan')"><i class="fa fa-check"></i> Diterima</a>
                          <a href="/tolakLaporan/{{ $item['id_laporan'] }}" class="btn btn-danger" onclick="return confirm('Yakin Menolak Pengajuan!')"><i class="fa fa-times"></i> Tolak</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
