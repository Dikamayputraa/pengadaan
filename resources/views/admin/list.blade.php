        ...
        <div class="row">
          <div class="col-12">
            <div class="text-right mb-2">
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-plus"></i> Add Admin</button>
            </div>
            <div class="card">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="deleteAdmin/{{ $admin->id_admin }}"  onclick="return confirm('Apakah Anda Yakin Mengahpus Data?')">
