<!-- Modal -->
<div class="modal fade" id="passwordAdm" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="passwordAdm" method="post" role="form">
            {{ csrf_field() }}
