                    ...
                    <tr>
                      ...
                      <td>
                        @if($item['status_pengajuan'] == 1)
                          <a href="terimaPengajuan/{{ $item['id_pengajuan'] }}" class="btn btn-primary" onclick="return confirm('Tekan Ya Untuk Menerima Pengajuan')"><i class="fa fa-check"></i> Terima</a>
                          <a href="tolakPengajuan/{{ $item['id_pengajuan'] }}" class="btn btn-warning" onclick="return confirm('Tekan Ya Untuk Menolak Pengajuan')"><i class="fa fa-times"></i> Tolak</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
